...
$fields = DCFEM_Settings::get_fields('shipping');
?>
<div id="tabs-2"  class="dcfem-tab">
    <div class="dcfem-form-wrapper">
        ...
        <div class="dcfem-preview-box dcfem-preview-shipping-form">
            <h3 class="dcfem-preview-box-title"><?php echo esc_html__( 'Shipping Details', 'checkout-field-builder-checkout-manager-for-woocommerce' ); ?></h3>
            <div class="dcfem-preview-box-content">
                <?php
                $checkout = \wc()->checkout();
                $checkout_billing_fields = $checkout->get_checkout_fields('shipping');
