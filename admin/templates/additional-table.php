...
$fields = DCFEM_Settings::get_fields('additional');
?>
<div id="tabs-3"  class="dcfem-tab">
    <div class="dcfem-form-wrapper">
        <table class="dcfem_checkout_fields wc_gateways widefat thpladmin_fields_table" cellspacing="0">
            <thead>
                <tr>
                    <th colspan="4">
        ...
        <div class="dcfem-preview-box dcfem-preview-additional-form">
            <h3 class="dcfem-preview-box-title"><?php echo esc_html__('Additional Details', 'checkout-field-builder-checkout-manager-for-woocommerce'); ?></h3>
            <div class="dcfem-preview-box-content">
                <?php
                $checkout = \wc()->checkout();
                $checkout_billing_fields = $checkout->get_checkout_fields('order');
